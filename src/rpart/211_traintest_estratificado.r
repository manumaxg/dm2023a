...
particionar  <- function( data,  division, agrupa="",  campo="fold", start=1, seed=158771 )
{
...
setwd("C:/Users/mmgma/OneDrive/Escritorio/Data Mining")  #Establezco el Working Directory
...
particionar( dataset, division=c(7,3), agrupa="clase_ternaria", seed= 158771 )  #Cambiar por la primer semilla de cada uno !
