...
PARAM  <- list()
PARAM$experimento <- "TS741021"

PARAM$exp_input  <- "FE731021"
...
PARAM$train$training     <- c( 202105, 202104, 202103, 202102, 202101, 202010, 202009, 202008, 202007, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906)
PARAM$train$validation   <- c( 202106, 202011 )
