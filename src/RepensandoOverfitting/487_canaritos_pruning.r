...
setwd("C:\\Users\\mmgma\\OneDrive\\Escritorio\\Data Mining\\exp\\KA2001\\dm2023a")
#establezco la carpeta donde voy a trabajar #establezco la carpeta donde voy a trabajar
