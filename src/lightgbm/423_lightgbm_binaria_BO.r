...
PARAM$trainingstrategy$semilla_azar   <- 158771  #Aqui poner su  primer  semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 616523  #Aqui poner su segunda semilla
...
PARAM$hyperparametertuning$hs  <- makeParamSet(
         ...
         makeNumericParam("min_gain_to_split", lower = 0, upper = 2 ),
